...
@ApplicationScoped
public class BajaEquipoMapperImpl implements BajaEquipoMapper {

    @Override
    public BajaEquipo toEntity(BajaEquipoDto bajaEquipoDto, CycleAvoidingMappingContext context) {
        BajaEquipo target = context.getMappedInstance( bajaEquipoDto, BajaEquipo.class );
        if ( target != null ) {
            return target;
        }
        ...
        context.storeMappedInstance( bajaEquipoDto, bajaEquipo );

        bajaEquipo.setId( bajaEquipoDto.getId() );
        bajaEquipo.setIdUsuario( usuarioDtoToUsuario( bajaEquipoDto.getIdUsuario(), context ) );
        bajaEquipo.setIdEquipo( equipoDtoToEquipo( bajaEquipoDto.getIdEquipo(), context ) );
        bajaEquipo.setRazon( bajaEquipoDto.getRazon() );
        bajaEquipo.setFecha( bajaEquipoDto.getFecha() );
        bajaEquipo.setEstado( bajaEquipoDto.getEstado() );
        bajaEquipo.setComentarios( bajaEquipoDto.getComentarios() );

        return bajaEquipo;
    }

    @Override
    public BajaEquipoDto toDto(BajaEquipo bajaEquipo, CycleAvoidingMappingContext context) {
        BajaEquipoDto target = context.getMappedInstance( bajaEquipo, BajaEquipoDto.class );
        if ( target != null ) {
            return target;
        }
        ...
        context.storeMappedInstance( bajaEquipo, bajaEquipoDto );

        bajaEquipoDto.setId( bajaEquipo.getId() );
        bajaEquipoDto.setRazon( bajaEquipo.getRazon() );
        bajaEquipoDto.setFecha( bajaEquipo.getFecha() );
        bajaEquipoDto.setEstado( bajaEquipo.getEstado() );
        bajaEquipoDto.setComentarios( bajaEquipo.getComentarios() );
        bajaEquipoDto.setIdUsuario( usuarioToUsuarioDto( bajaEquipo.getIdUsuario(), context ) );
        bajaEquipoDto.setIdEquipo( equipoToEquipoDto( bajaEquipo.getIdEquipo(), context ) );

        return bajaEquipoDto;
    }

    @Override
    public BajaEquipo partialUpdate(BajaEquipoDto bajaEquipoDto, BajaEquipo bajaEquipo) {
        if ( bajaEquipoDto == null ) {
            return bajaEquipo;
        }

        if ( bajaEquipoDto.getId() != null ) {
            bajaEquipo.setId( bajaEquipoDto.getId() );
        }
        if ( bajaEquipoDto.getIdUsuario() != null ) {
            if ( bajaEquipo.getIdUsuario() == null ) {
                bajaEquipo.setIdUsuario( new Usuario() );
            }
            usuarioDtoToUsuario1( bajaEquipoDto.getIdUsuario(), bajaEquipo.getIdUsuario() );
        }
        if ( bajaEquipoDto.getIdEquipo() != null ) {
            if ( bajaEquipo.getIdEquipo() == null ) {
                bajaEquipo.setIdEquipo( new Equipo() );
            }
            equipoDtoToEquipo1( bajaEquipoDto.getIdEquipo(), bajaEquipo.getIdEquipo() );
        }
        if ( bajaEquipoDto.getRazon() != null ) {
            bajaEquipo.setRazon( bajaEquipoDto.getRazon() );
        }
        if ( bajaEquipoDto.getFecha() != null ) {
            bajaEquipo.setFecha( bajaEquipoDto.getFecha() );
        }
        if ( bajaEquipoDto.getEstado() != null ) {
            bajaEquipo.setEstado( bajaEquipoDto.getEstado() );
        }
        if ( bajaEquipoDto.getComentarios() != null ) {
            bajaEquipo.setComentarios( bajaEquipoDto.getComentarios() );
        }
    ...
    @Override
    public List<BajaEquipo> toEntity(List<BajaEquipoDto> bajaEquipoDto, CycleAvoidingMappingContext context) {
        List<BajaEquipo> target = context.getMappedInstance( bajaEquipoDto, List.class );
        if ( target != null ) {
            return target;
        }
        ...
        List<BajaEquipo> list = new ArrayList<BajaEquipo>( bajaEquipoDto.size() );
        context.storeMappedInstance( bajaEquipoDto, list );

        for ( BajaEquipoDto bajaEquipoDto1 : bajaEquipoDto ) {
            list.add( toEntity( bajaEquipoDto1, context ) );
        }
    ...
    @Override
    public List<BajaEquipoDto> toDto(List<BajaEquipo> bajaEquipo, CycleAvoidingMappingContext context) {
        List<BajaEquipoDto> target = context.getMappedInstance( bajaEquipo, List.class );
        if ( target != null ) {
            return target;
        }
        ...
        List<BajaEquipoDto> list = new ArrayList<BajaEquipoDto>( bajaEquipo.size() );
        context.storeMappedInstance( bajaEquipo, list );

        for ( BajaEquipo bajaEquipo1 : bajaEquipo ) {
            list.add( toDto( bajaEquipo1, context ) );
        }
    ...
    protected Set<EquiposUbicacione> equiposUbicacioneDtoSetToEquiposUbicacioneSet1(Set<EquiposUbicacioneDto> set) {
        ...
        Set<EquiposUbicacione> set1 = new LinkedHashSet<EquiposUbicacione>( Math.max( (int) ( set.size() / .75f ) + 1, 16 ) );
        for ( EquiposUbicacioneDto equiposUbicacioneDto : set ) {
            set1.add( equiposUbicacioneDtoToEquiposUbicacione1( equiposUbicacioneDto ) );
        }
    ...
    protected EquiposUbicacione equiposUbicacioneDtoToEquiposUbicacione1(EquiposUbicacioneDto equiposUbicacioneDto) {
        if ( equiposUbicacioneDto == null ) {
            return null;
        }
